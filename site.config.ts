...
export default siteConfig({
  ...
  domain: 'blog.tiagojs.xyz',
  author: 'Tiago J. Silva',

  // open graph metadata (optional)
  description: 'Um website criado com o objetivo de armazenar todo meu conhecimento de T.I adquirido através dos meus ~12 anos de experiência',
